	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'burn/cover',
				[
					'title' => __( 'Burn Cover', 'burn' ),
					'description' => __( 'Burn Cover Block with image and text', 'burn' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'burn/two-columns',
				[
					'title' => __( 'Burn Two Column', 'burn' ),
					'description' => __( 'Burn two columns with heading and text', 'burn' ),
					'categories' => [ 'columns' ],
